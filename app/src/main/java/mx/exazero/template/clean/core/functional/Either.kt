package mx.exazero.template.clean.core.functional
...
/**
 *  Created by JAzcorra96 on 9/24/2020
 */
...
fun <L, R> Either<L, R>.failureOrElse(value: L): L =
    when (this) {
        is Either.Left -> a
...
fun <L, R> Either<L, R>.failureOrThrow(): L =
    when (this) {
        is Either.Left -> a
